"""Native host RTABMAP — alternative mapping host (Pi B / VIO).

Preferred entrypoint is pi/lidar/launch/host_rtabmap.launch.py (Pi A): local
lidar + OV odom over DDS. Use this when RTABMAP already runs on the VIO Pi.

Consumes OpenVINS external odometry + Blackfly mono image (+ optional lidar
/scan from Pi A over CycloneDDS). Does not start OpenVINS or rgbd_odometry.
"""
